...
export function BrainPage() {
  ...
  return (
    <div style={{ display: "grid", gap: 16, maxWidth: 900 }}>
      {/* Header */}
      <div>
        <h1 style={{ fontSize: 22, fontWeight: 700, margin: "0 0 4px", color: "rgba(255,255,255,0.95)" }}>
          Brain
        </h1>
        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", margin: 0 }}>
          Upload your swipe files of high-performing ads. The Brain learns what good ads look like and uses them as reference material during generation.
        </p>
      </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div
            style={{
              ...
              animation: trainingStatus === "processing" ? "pulse 1.5s infinite" : "none",
            }}
          />
          <span style={{ fontSize: 12, color: statusColors[trainingStatus], fontWeight: 500 }}>
      ...
      {files.length > 0 && (
        <div
          style={{
            display: "grid",
            gridTemplateColumns: "repeat(auto-fill, minmax(130, 1fr))",
            gap: 10,
          }}
        >
          {files.map((f) => (
      ...
      >
        ...
        <button
          ...
          disabled={files.length === 0 || trainingStatus === "processing"}
          style={{
            padding: "8px 24px",
            fontSize: 13,
            fontWeight: 600,
            background: files.length === 0 || trainingStatus === "processing" ? "rgba(99,102,241,0.3)" : "#6366f1",
            color: "#fff",
            border: "none",
            borderRadius: 8,
            cursor: files.length === 0 || trainingStatus === "processing" ? "default" : "pointer",
